...
const SocialIconsListLink = styled.a`
  align-items: center; 
  color: #2b2525;
  display: flex;
  margin: 7px 0;
...
const SocialIconsListText = styled.span`
  font-weight: 600;
  margin-left: 20px;
  padding-top: 2px;
`;
  ...
  <SocialIconsList>
    <li>
      ...
      >
        ...
        <SocialIconsListText>GitHub</SocialIconsListText>
      </SocialIconsListLink>
    </li>
    <li>
      <SocialIconsListLink 
      ...
      >
        ...
        <SocialIconsListText>CodePen</SocialIconsListText>
      </SocialIconsListLink>
    </li>
    <li>
      <SocialIconsListLink href="https://twitter.com/bobmatyas" rel="me noopener noreferrer" target="_blank" className="social__icons__item">
        <SocialIconsListIcon>
        ...
        <SocialIconsListText>Twitter</SocialIconsListText>
      </SocialIconsListLink>
    </li>
    <li>
      <SocialIconsListLink 
        href="https://mastodon.social/@bobmatyas"  
        rel="me noopener noreferrer" 
        target="_blank"
      >
        <SocialIconsListIcon>
        ...
        <SocialIconsListText>Mastodon</SocialIconsListText>
      </SocialIconsListLink>
    </li>
    <li>
      <SocialIconsListLink 
        href="https://www.linkedin.com/in/bob-matyas"  
        rel="me noopener noreferrer" 
        target="_blank"
      >
        ...
        <SocialIconsListText>LinkedIn</SocialIconsListText>
      </SocialIconsListLink>
    </li>
  </SocialIconsList>
)

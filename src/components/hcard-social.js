...
const HcardSocial = () => (
    <SocialIconsList>
        ...
        <li>
            ...
            <span className="sr-only">Bobmatyas on GitHub</span>
            </a>
        </li>
        <li>
            <a 
            ...
            <span className="sr-only">Bob Matyas on CodePen</span>
            </a>
        </li>
        <li>
            <a 
                className="u-url" 
                rel="me" 
                href="https://twitter.com/bobmatyas"
            > 
            <SocialIconsListIcon>
            ...
            <span className="sr-only">Bob Matyas on Twitter</span>
            </a>
        </li>
        <li>
            <a 
            ...
            <span className="sr-only">Bob Matyas on Mastodon</span>
            </a>
        </li>
        <li>
            <a 
            ...
            <span className="sr-only">Bob Matyas on Linkedin</span>
            </a>
        </li>
    </SocialIconsList>
)

export default HcardSocial;
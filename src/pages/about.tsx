  ...
  <Layout>
    ...
    <div className="main">
      ...
      <p>
        ...
        and the open web. I have been building websites since the late 1990s. I
        remember the days – and pain – of folks making sites using strange hacks
        and table-based layouts. We’ve come a long way since then and I love
        learning the new things coming to the web platform.{" "}
      </p>
      ...
      <p>
        I have <Link to={`/portfolio/`}>a portfolio</Link> of non-work projects
        available here.
      </p>
      <h2>Get in Touch</h2>

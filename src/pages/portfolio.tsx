...
export const pageQuery = graphql`
  {
    ...
    imageWhereWorld: file(
      relativePath: { eq: "images/portfolio-where_world.jpg" }
    ) {
      childImageSharp {
        gatsbyImageData(width: 600, layout: CONSTRAINED)
      }
    ...
    imageDrumMachine: file(
      relativePath: { eq: "images/portfolio-drum_machine.jpg" }
    ) {
      childImageSharp {
        gatsbyImageData(width: 600, layout: CONSTRAINED)
      }
    ...
    imageFoodFight: file(
      relativePath: { eq: "images/portfolio-food_fight.jpg" }
    ) {
      childImageSharp {
        gatsbyImageData(width: 600, layout: CONSTRAINED)
      }

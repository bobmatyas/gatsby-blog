  ...
  <Layout>
    ...
    <div className="main__content">
      ...
      <div className="projects__card">
        ...
        <p className="projects__card__description">
          It queries two different APIs to provide the functionality: PixaBay and ColorTag. I wrote the JavaScript that interfaces with the PixaBay API, participated in the overall architecting of the app. I also implemented the CSS and JavaScript that allows for toggling between light and dark mode.
        </p>
      ...
      <div className="projects__card">
        <div className="projects__card__image">
          <Img style={styles}
            fluid={data.imageLilySpa.childImageSharp.fluid}
            alt="lily spa screenshot"
          />
        </div>

        <h3 className="projects__card__heading">Lily Spa</h3>
        ...
        <div className="projects__card__view">
          ...
          <div class="projects__card__view__inner">
            View: <a href="https://bobmatyas.github.io/lily-spa-pos/">Online</a> | <a href="https://github.com/bobmatyas/lily-spa-pos">Code</a>
          </div>
        ...
        <h4 className="projects__card__technologies">
          ...
          <ul className="projects__card__technologies__list">
            ...
            <li className="projects__card__technologies__list__item">CSS</li>
            <li className="projects__card__technologies__list__item">JAVASCRIPT</li>
            <li className="projects__card__technologies__list__item">JQUERY</li>
          </ul>
      </div>
      ...
      <div className="projects__card">
        <div className="projects__card__image">
          <Img style={styles}
            fluid={data.imageDrumMachine.childImageSharp.fluid}
            alt="drum machine screenshot"
          />
        </div>

        <h3 className="projects__card__heading">Drum Machine</h3>
        ...
        <div className="projects__card__view">
          ...
          <div class="projects__card__view__inner">
            View: <a href="https://codepen.io/bobmatyas/full/mNENyP ">Online</a> | <a href="https://codepen.io/bobmatyas/pen/mNENyP">Code</a>
          </div>
        ...
        <h4 className="projects__card__technologies">
          ...
          <ul className="projects__card__technologies__list">
            ...
            <li className="projects__card__technologies__list__item">CSS</li>
            <li className="projects__card__technologies__list__item">JAVASCRIPT</li>
            <li className="projects__card__technologies__list__item">REACTJS</li>
          </ul>
      </div>
      ...
      <div className="projects__card">
        <div className="projects__card__image">
          <Img style={styles}
            fluid={data.imageJban.childImageSharp.fluid}
            alt="jban screenshot"
          />
        </div>

        <h3 className="projects__card__heading">John Ball Area Neighbors</h3>
        ...
        <h4 className="projects__card__technologies">
          ...
          <ul className="projects__card__technologies__list">
            <li className="projects__card__technologies__list__item">WordPress</li>
            <li className="projects__card__technologies__list__item">HTML</li>
            <li className="projects__card__technologies__list__item">CSS</li>
            <li className="projects__card__technologies__list__item">PHP</li>
            <li className="projects__card__technologies__list__item">SEO</li>
          </ul>
      </div>
